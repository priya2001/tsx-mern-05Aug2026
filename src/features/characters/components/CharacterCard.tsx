  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="relative flex h-full w-full flex-col gap-4 rounded-[24px] text-left outline-none transition focus-visible:ring-2 focus-visible:ring-hyperspace-200 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
        onClick={() => {
          onSelect(character);
        }}
      >
